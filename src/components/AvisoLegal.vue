<template>
  <fragment>
    ...
    <section class="legal">
      <h2>Aviso Legal</h2>
      <h4>Identificación y Titularidad</h4>
      ...
      <h4>Enlaces de interés a otros sitios Web</h4>
      ...
      <h4>Todos los derechos están reservados.</h4>
      ...
      <p>Siempre que no haya una norma que obligue a otra cosa, para cuantas cuestiones se susciten sobre la interpretación, aplicación y cumplimiento de este Aviso Legal, así como de las reclamaciones que puedan derivarse de su uso, las partes acuerdan someterse a los Jueces y Tribunales de la provincia de {{provincia}}, con renuncia expresa de cualquier otra jurisdicción que pudiera corresponderles.</p>
      <h4>Contacto</h4>
      <p>En caso de que usted tenga cualquier duda acerca de estas Condiciones legales o quiera realizar cualquier comentario sobre este sitio Web, puede enviar un mensaje de correo electrónico a la dirección {{email}}</p>
      <h4>Condiciones de Venta</h4>
      <p>En este apartado detallarás los pasos que debe realizar el usuario para completar una compra.</p>
    </section>
  </fragment>
</template>
